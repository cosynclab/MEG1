function []=MS_hcp_icaplotconnectome(connectome, sourcemodel2d, options)
...
if strcmp(sortindx,'yes')
    ...
    parcel_net= [0 2 16 16 16 16 0 0 6 6 6 6 12 12 12 12 12 12 10 5 13 13 13 13 13 13 13 ...
        ...
        2 16 16 16 16 16 16 0 0 6 6 6 6 12 12 12 12 12 12 10 5 5 13 13 13 13 13 ...
        17 17 17 17 17 15 15 15 1 4 9 11 11 11 3 3 8 8 8 8 8 7 7 7 7 14 14];
...
if strcmp(plot_parc,'yes')
    ...
    if(strcmp(saveparc,'yes'))
        ...
        save(fname,'connect_parc','mask_c')
    end
